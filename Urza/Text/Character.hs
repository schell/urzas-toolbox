...
loadCharMap :: Renderer -> String -> IO Renderer
loadCharMap r str = foldM loadChar r str


charIsLoaded :: Renderer -> Char -> Bool
...
loadChar :: Renderer -> Char -> IO Renderer
...
-- atlas texture.
loadCharacter :: Renderer -> Char -> IO Renderer
...
drawChar :: Renderer -> PenPosition -> Char -> IO PenPosition
...
-- | Returns an empty BufferAccumulator
emptyBufferAccumulator :: Atlas -> BufferAccumulator
emptyBufferAccumulator atls = BufferAcc atls mempty (Position 0 0) (0, -1/0) (0, -1/0)
